...
def SetupAll(BasePath, CheckPointPath):
    ...
    """
    # Setup DirNames
    DirNamesTrain = SetupDirNames(BasePath)[0]
    DirNamesVal = SetupDirNames(BasePath)[1]

    # Read and Setup Labels
    LabelsPathTrain = '/home/jc-merlab/RBE549-Computer_Vision/schatterjee_p1/Phase2/Code/TxtFiles/LabelsTrain.txt'
...
def SetupDirNames(BasePath):
    ...
    """
    DirNamesTrain = ReadDirNames("/home/jc-merlab/RBE549-Computer_Vision/schatterjee_p1/Phase2/Code/TxtFiles/DirNamesTrain.txt")
    DirNamesVal = ReadDirNames("/home/jc-merlab/RBE549-Computer_Vision/schatterjee_p1/Phase2/Code/TxtFiles/DirNamesVal.txt")
